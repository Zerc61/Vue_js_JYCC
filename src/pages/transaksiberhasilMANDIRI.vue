<template>
  <div class="pay-page">
    ...
    <div class="wrap center-content">
      <h2 class="section-title">Pembayaran Mandiri Virtual Account</h2>
      <p class="sub">Transfer ke nomor rekening di bawah ini</p>

      <div class="va-container">
        <img :src="require('@/assets/MANDIRI.png')" alt="Mandiri Logo" class="bank-logo" />
        <p class="va-number">{{ vaNumber }}</p>
        <p class="va-label">Nomor Virtual Account Mandiri</p>
      </div>
      ...
      <div class="instructions">
        <ol>
          ...
          <li>Pilih menu Transfer > Ke Rekening Mandiri Virtual Account.</li>
...
export default {
  ...
  data() {
    return {
      total: 50000,
      vaNumber: "1122334455667788", // Dalam produksi, dapatkan dari API Midtrans
      timeLeft: 900,
      timerInterval: null
    };
  },
