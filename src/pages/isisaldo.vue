        ...
        <div class="detail-box" v-if="rupiah || selected">
          ...
          <div class="detail-item">
            ...
            <div class="detail-content">
              <strong>Harga Emas per Gram:</strong> Rp
              {{ formatNum(hargaEmas) }}
            </div>
          </div>
          ...
          <div class="detail-item" v-if="rupiah">
            <span class="detail-icon">🔄</span>
            <div class="detail-content">
              <strong>Rupiah → Emas:</strong> {{ formatNum(rupiah) }} =
              <span class="highlight"
                >{{ emasFromRupiah.toFixed(4) }} gram</span
              >
            </div>
          </div>
          ...
          <div class="detail-item" v-if="selected">
            <span class="detail-icon">🪙</span>
            <div class="detail-content">
              <strong>D’coin → Rupiah:</strong> {{ formatNum(selected) }} D’coin
              =
