<template>
  <div class="page">
    ...
    <nav class="bottom-nav" aria-label="Bottom navigation">
      <router-link v-for="(n, i) in bottomNav"
        :key="i"
        :to="n.route"
        class="nav-btn"
      >
  ...
  data() {
    return {
      ...
      bottomNav: [
        ...
        { label: "Promo", icon: "⭐", route: "/promo" },
        { label: "Wishlist", icon: "❤️", route: "/wishlist" },
        { label: "Akun", icon: "👤", route: "/profil" }
      ]
    };
  },
...
.promo-media img { width:100%; height:140px; object-fit:cover; }
.promo-body { display:flex; justify-content:space-between; padding:10px 12px; }
...
.umkm-photo {
  width:60px; height:60px; border-radius:10%;
  object-fit:cover;
  box-shadow:0 6px 14px rgba(15,23,42,0.06);
}
.umkm-name { font-size:12px; }
